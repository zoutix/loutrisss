...
(function (global) {
  ...
  var ACHIEVEMENTS = [
    ...
    { id: "streak_10", icon: "bolt", name: "On Fire", desc: "10-win streak", cond: function (s) { return s.bestStreak >= 10; } },
    { id: "perfect", icon: "star", name: "First Try", desc: "Solve in 1 guess", cond: function (s) { return s.perfectSolves >= 1; } },
    { id: "perfect_10", icon: "gem", name: "No Misses", desc: "10 perfect solves", cond: function (s) { return s.perfectSolves >= 10; } },
    { id: "ranked_play", icon: "shield", name: "Fighter", desc: "Play 10 ranked matches", cond: function (s) { return s.rankedPlayed >= 10; } },
    { id: "multi_25", icon: "users", name: "Team Player", desc: "25 multiplayer matches", cond: function (s) { return s.multiPlayed >= 25; } },
    ...
    { id: "level_10", icon: "bolt", name: "Getting Good", desc: "Reach level 10", cond: function (s) { return s.level >= 10; } },
    { id: "level_25", icon: "medal", name: "Experienced", desc: "Reach level 25", cond: function (s) { return s.level >= 25; } },
    { id: "rich", icon: "coin", name: "Tycoon", desc: "Hold 50,000 coins", cond: function (s) { return s.coins >= 50000; } },
    { id: "wordsmith", icon: "book", name: "Word Expert", desc: "Play 200 matches", cond: function (s) { return s.wins + s.losses >= 200; } }
  ];
